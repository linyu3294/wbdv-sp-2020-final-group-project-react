...
class HomeComponent extends React.Component {
    ...
    render() {
        return (
            <div class="container">
                <h1>Welcome To RentMatch.com</h1>
                <div class="row">
                    <div class="col-12">
                        <div className="jumbotron">
                            <h1 className="display-4">Welcome To RentMatch.com!</h1>
                            ...
                            <p>A large subset of the housing population is renters and landlords.
                                ...
                                preferences, and character qualities. Essentially, our project
                                creates a platform for renters to search for housing and for
                                landlords based on their profile, their ratings, and any other
